...
// 			}
// 		}
// 		function playSpollerVideo(spollerBlock) {
...
// 		function resetSpollerVideo(spollerBlock) {
// 		    const video = spollerBlock.querySelector("video[data-spollers-video]");
// 		    if (!video) return;
...
// 						// --- Воспроизведение видео при открытии ---
// 						if (!spollerBlock.open) {
// 						    // блок только что ОТКРЫВАЕТСЯ
// 						    setTimeout(() => {
// 						        playSpollerVideo(spollerBlock);
// 						    }, spollerSpeed);
// 						} else {
// 						    // блок только что ЗАКРЫЛСЯ
